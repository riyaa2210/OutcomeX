      ...
      <div className="p-6 md:p-10">
        <Tabs.Root defaultValue="login">
          ...
          <Tabs.Content value="login" className="pt-6">
            <AuthForm form={form} setForm={setForm} error={error} onSubmit={onSubmit} buttonText="Login" />
          </Tabs.Content>
          <Tabs.Content value="register" className="pt-6">
            <AuthForm form={form} setForm={setForm} error={error} onSubmit={onSubmit} buttonText="Register" />
          </Tabs.Content>
        </Tabs.Root>
      </div>
    </Motion.section>
...
function AuthForm({ form, setForm, error, onSubmit, buttonText }) {
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <Motion.button
        type="submit"
        className="w-full rounded-xl bg-violet-600 px-4 py-2 font-semibold text-white shadow-sm shadow-violet-600/25 dark:shadow-violet-900/40"
        {...buttonHoverProps}
